  ...
  const SQLParser = (function () {
    ...
    require['./lexer'] = new function () {
      ...
      (function () {
        ...
        Lexer = (function () {
          let BOOLEAN, DBLSTRING, LITERAL, MATH, MATH_MULTI, NUMBER, SEPARATOR, SQL_CONDITIONALS, SQL_FUNCTIONS, SQL_KEYWORDS, SQL_OPERATORS, SQL_SORT_ORDERS, STAR, STRING, WHITESPACE
      ...
      const exports = this;
      (function () {
        let Field, FunctionValue, Group, Having, Join, Limit, LiteralValue, Op, Order, OrderArgument, Select, Star, StringValue, SubSelect, Table, Union, Where, indent
        ...
        exports.Select = Select = (function () {
          ...
          Select.prototype.toString = function () {
            let join, ret, union, _i, _j, _len, _len2, _ref, _ref2
