...
describe('parsing tests', function() {
  ...
  it('should handle WHERE = with dot notation', function() {
    var q = sqltomango("SELECT a,b,c FROM mytable WHERE name.d='1'");
